...
public class TemplateConfiguration {
	...
	private final String[] TEMPLATE_PATHS = new String[] {
			...
			"authlib_fragments/admin/user/roles/custom.mustache",
			"authlib_fragments/admin/user/roles/multiple.mustache",
			"authlib_fragments/admin/user/roles/single.mustache",
			"authlib_fragments/assets.mustache",
			"authlib_fragments/css.mustache",
			"authlib_fragments/default_session_timeout_modal.mustache",
			...
			"authlib_fragments/meta_tags.mustache",
